...
{
    public partial class CodeCampEvalsManager
    {
        ...
        public List<CodeCampEvalsResult> Get(CodeCampEvalsQuery query)
        {
   ...
   IQueryable<CodeCampEvalsResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<CodeCampEvalsResult> GetAll()
        {
            return Get(new CodeCampEvalsQuery {IsMaterializeResult = true});
        }
    }
}
