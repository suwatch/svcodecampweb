...
{
    public partial class AttendeesTagListManager
    {
        ...
        public List<AttendeesTagListResult> Get(AttendeesTagListQuery query)
        {
   ...
   IQueryable<AttendeesTagListResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<AttendeesTagListResult> GetAll()
        {
            return Get(new AttendeesTagListQuery {IsMaterializeResult = true});
        }
    }
}
