...
{
    public partial class UsersInRolesMembershipManager
    {
        ...
        public List<UsersInRolesMembershipResult> Get(UsersInRolesMembershipQuery query)
        {
   ...
   IQueryable<UsersInRolesMembershipResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<UsersInRolesMembershipResult> GetAll()
        {
            return Get(new UsersInRolesMembershipQuery {IsMaterializeResult = true});
        }
    }
}
