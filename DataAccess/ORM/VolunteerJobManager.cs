...
{
    public partial class VolunteerJobManager
    {
        ...
        public List<VolunteerJobResult> Get(VolunteerJobQuery query)
        {
   ...
   IQueryable<VolunteerJobResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<VolunteerJobResult> GetAll()
        {
            return Get(new VolunteerJobQuery {IsMaterializeResult = true});
        }
    }
}
