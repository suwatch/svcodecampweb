...
{
    public partial class SponsorListContactTypeManager
    {
        ...
        public List<SponsorListContactTypeResult> Get(SponsorListContactTypeQuery query)
        {
            ...
            IQueryable<SponsorListContactTypeResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<SponsorListContactTypeResult> GetAll()
        {
            return Get(new SponsorListContactTypeQuery {IsMaterializeResult = true});
        }
