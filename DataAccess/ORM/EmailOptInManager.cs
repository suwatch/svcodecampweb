...
{
    public partial class EmailOptInManager
    {
        ...
        public List<EmailOptInResult> Get(EmailOptInQuery query)
        {
   ...
   IQueryable<EmailOptInResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<EmailOptInResult> GetAll()
        {
            return Get(new EmailOptInQuery {IsMaterializeResult = true});
        }
    }
}
