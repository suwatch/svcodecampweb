...
Ext.extend(Ext.grid.RowExpander, Ext.util.Observable, {
    ...
    getRemoteDataMethod : function (record, index) {
        ...
        return this.remoteDataMethod.call(this, record, index, this.grid);
    },
    ...
    beforeExpand : function(record, body, rowIndex) {
        if (this.fireEvent('beforexpand', this, record, body, rowIndex) !== false) {
            ...
            if (this.remoteDataMethod) {
                if (this.expanderDivId) {
                    this.tpl = new Ext.Template("<div id='" + this.expanderDivId + "remData" + rowIndex + "' class='rem-data-expand'><\div>");
                } else {
    ...
    expandRow : function(row) {
        ...
        var body = Ext.DomQuery.selectNode('tr.x-grid3-row-body-tr div.x-grid3-row-body', row);
