...
{
    public partial class EmailOptOutManager
    {
        ...
        public List<EmailOptOutResult> Get(EmailOptOutQuery query)
        {
   ...
   IQueryable<EmailOptOutResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<EmailOptOutResult> GetAll()
        {
            return Get(new EmailOptOutQuery {IsMaterializeResult = true});
        }
    }
}
