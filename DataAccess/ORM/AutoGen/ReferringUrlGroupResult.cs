...
{
    public partial class ReferringUrlGroupResult : ResultBase
    {
        [DataMember] public string ReferringUrlName { get; set; }
        [DataMember] public int AttendeesId { get; set; }
        [DataMember] public string ArticleName { get; set; }
        [DataMember] public string UserGroup { get; set; }
        [DataMember] public int DeletedCount { get; set; }
