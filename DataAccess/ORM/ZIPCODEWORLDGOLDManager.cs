...
{
    public partial class ZIPCODEWORLDGOLDManager
    {
        ...
        public List<ZIPCODEWORLDGOLDResult> Get(ZIPCODEWORLDGOLDQuery query)
        {
   ...
   IQueryable<ZIPCODEWORLDGOLDResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<ZIPCODEWORLDGOLDResult> GetAll()
        {
            return Get(new ZIPCODEWORLDGOLDQuery {IsMaterializeResult = true});
        }
    }
}
