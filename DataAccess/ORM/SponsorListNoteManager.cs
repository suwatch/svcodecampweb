...
{
    public partial class SponsorListNoteManager
    {
        ...
        public List<SponsorListNoteResult> Get(SponsorListNoteQuery query)
        {
   ...
   IQueryable<SponsorListNoteResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<SponsorListNoteResult> GetAll()
        {
            return Get(new SponsorListNoteQuery {IsMaterializeResult = true});
        }
    }
}
