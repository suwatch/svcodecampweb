...
{
    public partial class GuidRouterManager
    {
        ...
        public List<GuidRouterResult> Get(GuidRouterQuery query)
        {
   ...
   IQueryable<GuidRouterResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<GuidRouterResult> GetAll()
        {
            return Get(new GuidRouterQuery {IsMaterializeResult = true});
        }
    }
}
