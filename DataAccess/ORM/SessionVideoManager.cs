...
{
    public partial class SessionVideoManager
    {
        ...
        public List<SessionVideoResult> Get(SessionVideoQuery query)
        {
   ...
   IQueryable<SessionVideoResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<SessionVideoResult> GetAll()
        {
            return Get(new SessionVideoQuery {IsMaterializeResult = true});
        }
    }
}
