...
{
    public partial class ConfigurationDataManager
    {
        ...
        public List<ConfigurationDataResult> Get(ConfigurationDataQuery query)
        {
   ...
   IQueryable<ConfigurationDataResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<ConfigurationDataResult> GetAll()
        {
            return Get(new ConfigurationDataQuery {IsMaterializeResult = true});
        }
    }
}
