...
{
    public partial class RolesInMembershipManager
    {
        ...
        public List<RolesInMembershipResult> Get(RolesInMembershipQuery query)
        {
   ...
   IQueryable<RolesInMembershipResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<RolesInMembershipResult> GetAll()
        {
            return Get(new RolesInMembershipQuery {IsMaterializeResult = true});
        }
    }
}
