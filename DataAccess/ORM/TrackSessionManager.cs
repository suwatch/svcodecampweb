...
{
    public partial class TrackSessionManager
    {
        ...
        public List<TrackSessionResult> Get(TrackSessionQuery query)
        {
   ...
   IQueryable<TrackSessionResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<TrackSessionResult> GetAll()
        {
            return Get(new TrackSessionQuery {IsMaterializeResult = true});
        }
    }
}
