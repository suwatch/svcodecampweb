...
{
    public partial class ProfileDataManager
    {
        ...
        public List<ProfileDataResult> Get(ProfileDataQuery query)
        {
   ...
   IQueryable<ProfileDataResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<ProfileDataResult> GetAll()
        {
            return Get(new ProfileDataQuery {IsMaterializeResult = true});
        }
    }
}
