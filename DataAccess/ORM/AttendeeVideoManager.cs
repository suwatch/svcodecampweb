...
{
    public partial class AttendeeVideoManager
    {
        ...
        public List<AttendeeVideoResult> Get(AttendeeVideoQuery query)
        {
   ...
   IQueryable<AttendeeVideoResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<AttendeeVideoResult> GetAll()
        {
            return Get(new AttendeeVideoQuery {IsMaterializeResult = true});
        }
    }
}
