...
{
    public partial class AttendeesTagListDetailManager
    {
        ...
        public List<AttendeesTagListDetailResult> Get(AttendeesTagListDetailQuery query)
        {
   ...
   IQueryable<AttendeesTagListDetailResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<AttendeesTagListDetailResult> GetAll()
        {
            return Get(new AttendeesTagListDetailQuery {IsMaterializeResult = true});
        }
    }
}
