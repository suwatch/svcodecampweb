...
{
    public partial class SessionLevelsManager
    {
        ...
        public List<SessionLevelsResult> Get(SessionLevelsQuery query)
        {
   ...
   IQueryable<SessionLevelsResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<SessionLevelsResult> GetAll()
        {
            return Get(new SessionLevelsQuery {IsMaterializeResult = true});
        }
    }
}
