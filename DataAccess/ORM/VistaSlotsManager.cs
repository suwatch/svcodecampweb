...
{
    public partial class VistaSlotsManager
    {
        ...
        public List<VistaSlotsResult> Get(VistaSlotsQuery query)
        {
   ...
   IQueryable<VistaSlotsResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<VistaSlotsResult> GetAll()
        {
            return Get(new VistaSlotsQuery {IsMaterializeResult = true});
        }
    }
}
