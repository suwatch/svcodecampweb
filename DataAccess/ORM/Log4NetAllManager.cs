...
{
    public partial class Log4NetAllManager
    {
        ...
        public List<Log4NetAllResult> Get(Log4NetAllQuery query)
        {
   ...
   IQueryable<Log4NetAllResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<Log4NetAllResult> GetAll()
        {
            return Get(new Log4NetAllQuery {IsMaterializeResult = true});
        }
    }
}
