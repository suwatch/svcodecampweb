...
{
    public partial class SessionsJobListingManager
    {
        ...
        public List<SessionsJobListingResult> Get(SessionsJobListingQuery query)
        {
   ...
   IQueryable<SessionsJobListingResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<SessionsJobListingResult> GetAll()
        {
            return Get(new SessionsJobListingQuery {IsMaterializeResult = true});
        }
    }
}
