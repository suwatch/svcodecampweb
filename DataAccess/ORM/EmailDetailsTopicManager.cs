...
{
    public partial class EmailDetailsTopicManager
    {
        ...
        public List<EmailDetailsTopicResult> Get(EmailDetailsTopicQuery query)
        {
   ...
   IQueryable<EmailDetailsTopicResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<EmailDetailsTopicResult> GetAll()
        {
            return Get(new EmailDetailsTopicQuery {IsMaterializeResult = true});
        }
    }
}
