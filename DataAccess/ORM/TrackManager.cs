...
namespace CodeCampSV
{
    public partial class TrackManager
    {
        ...
        public List<TrackResult> Get(TrackQuery query)
        {
            ...
            IQueryable<TrackResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<TrackResult> GetAll()
        {
            return Get(new TrackQuery {IsMaterializeResult = true});
        }
    }
}
