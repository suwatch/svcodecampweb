...
{
    public partial class SessionEvalsManager
    {
        ...
        public List<SessionEvalsResult> Get(SessionEvalsQuery query)
        {
   ...
   IQueryable<SessionEvalsResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<SessionEvalsResult> GetAll()
        {
            return Get(new SessionEvalsQuery {IsMaterializeResult = true});
        }
    }
}
