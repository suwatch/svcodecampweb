...
{
    public partial class ReferringUrlGroupManager
    {
        ...
        public List<ReferringUrlGroupResult> Get(ReferringUrlGroupQuery query)
        {
   ...
   IQueryable<ReferringUrlGroupResult> results = GetBaseResultIQueryable(baseQuery);
        ...
        public List<ReferringUrlGroupResult> GetAll()
        {
            return Get(new ReferringUrlGroupQuery {IsMaterializeResult = true});
        }
    }
}
